...
export default function Perfil(){
  ...
  useEffect(() => {
    ...
    const pesquisados = imoveis.filter((imovel) =>
      ...
      <section className="flex flex-col p-8 gap-4">
        <div className="flex flex-col gap-4">
          <div className="flex gap-2 items-center">
            ...
            <h1 className="text-3xl font-semibold text-zinc-900">Seus imóveis favoritos</h1>
          </div>
          <p className="text-zinc-500">Aqui você encontra todos os imóveis que você favoritou para acompanhar os leilões de forma rápida e prática.</p>
        </div>
